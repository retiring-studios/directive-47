...
internal static class Rendering
{
    ...
    /// <summary>
    /// One render at a time through this helper.
    /// </summary>
    ///
    /// <remarks>
    /// The hazard, and what it looks like when it bites, is written down once
    /// in <see cref="CompiledXaml"/>. What guards the assembly is the
    /// collection named there, which every class that builds a view now shares.
    ///
    /// <para>
    /// This stays anyway, because it is on the code path rather than on an
    /// attribute: a test class added here that forgets the collection is still
    /// safe as long as it renders through this helper, which all of them do.
    /// </para>
    /// </remarks>
